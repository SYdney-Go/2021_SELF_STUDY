...
* 깃헙 관리 시작
* 파이썬 공부
* 백준 풀이 시작 (https://github.com/SYdney-Go/2021_Baekjoon_Study) > 하위 서브 트리로 옮겼습니다.
* 인공지능 기초(https://github.com/SYdney-Go/2021_ICT_AI) > 하위 서브 트리로 옮겼습니다.
...
* django & 부트스트랩 (https://github.com/SYdney-Go/do_it_django_book_version) > 하위 서브 트리로 옮겼습니다.
